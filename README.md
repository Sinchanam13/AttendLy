...
| Role     | Email                  | Password   |
| -------- | ----------------------- | ---------- |
| Employee | employee@attendly.demo | password123 |
| Manager  | manager@attendly.demo  | password123 |
...
- Mark attendance for a date with a status of present, absent, or half-day.
